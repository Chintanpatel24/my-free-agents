...
```bash
curl -fsSL https://raw.githubusercontent.com/Chintanpatel24/my-free-claudecode/dev/install.sh | bash
```

### Windows (PowerShell)
Run the following command in PowerShell:
```powershell
irm https://raw.githubusercontent.com/Chintanpatel24/my-free-claudecode/dev/install.ps1 | iex
```
...
### macOS / Linux
```bash
curl -fsSL https://raw.githubusercontent.com/Chintanpatel24/my-free-claudecode/dev/update.sh | bash
```

### Windows (PowerShell)
```powershell
irm https://raw.githubusercontent.com/Chintanpatel24/my-free-claudecode/dev/update.ps1 | iex
```
